...
const testimonials = [
  ...
  {
    text: "“These AI tools have completely revolutionized our SEO strategy overnight”",
    name: "Jamie Lee",
    title: "Founder @ Pulse",
    avatarImg: avatar2,
  },
  ...
  return (
    <section className=" py-20 md:24">
      <div className="container ">
        ...
        <div className="flex  mt-10 [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)]">
          <motion.div
            initial={{
              translateX:'-50%',
            }}
